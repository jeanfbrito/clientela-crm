...
describe CompaniesController do
  describe "routing" do
    it "recognizes and generates #index" do
      { :get => "/companies" }.should_not be_routable
    end

    it "recognizes and generates #new" do
      { :get => "/companies/new" }.should route_to(:controller => "companies", :action => "show", :id => "new")
    end
    ...
    it "recognizes and generates #create" do
      { :post => "/companies" }.should_not be_routable
    end
    ...
    it "recognizes and generates #destroy" do
      { :delete => "/companies/1" }.should_not be_routable
    end
  end
end